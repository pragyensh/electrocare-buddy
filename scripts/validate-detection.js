...
const applianceAliases = {
  ac: ["ac", "a/c", "air conditioner", "air conditioning", "एसी", "ए.सी."],
  fridge: ["fridge", "refrigerator", "फ्रिज", "रेफ़्रिज़रेटर"],
  washingMachine: ["washing machine", "washer", "वॉशिंग मशीन", "वॉशिंगमशीन", "वाशिंग मशीन", "वाशिंगमशीन"],
  microwave: ["microwave", "microwave oven", "माइक्रोवेव"],
